...
namespace tools.Cache
{
    ...
    {
        public static string AppPath = AppDomain.CurrentDomain.BaseDirectory + "/Data/";
        ...
        public static class JsonSerialization
        {
            ...
            public static T ReadFromJsonFile<T>(string fileName) where T : new()
            {
                ...
                try
                {
                    ...
                    if (IsEncryptedJSON)
                        return Newtonsoft.Json.JsonConvert.DeserializeObject<T>(Cryptography.EncryptDecrypt(fileContents));
                    else
